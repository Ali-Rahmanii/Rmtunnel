...
سطح پیشنهادی (سبک/متوسط/سنگین/وحشتناک) با مقادیر آماده برای paste کردن توی
...
### ۴. فوروارد UDP
این پروژه فقط TCP رو حمل می‌کنه. برای UDP (WireGuard، بازی) نیاز به یک مسیر
کاملاً جدا برای forwarding مبتنی بر packet هست، چون کل مدل pool/session این
پروژه TCP-محوره.
