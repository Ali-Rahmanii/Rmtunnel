...
var tiers = []tierPreset{
	{"سبک (light)", 2, 6, 16, 16 * 1024, 65536, 65536, 1 << 20, 256 << 10, 16 << 10},
	{"متوسط (medium)", 4, 16, 64, 32 * 1024, 256 << 10, 256 << 10, 4 << 20, 1 << 20, 32 << 10},
	{"سنگین (heavy)", 8, 32, 128, 64 * 1024, 1 << 20, 1 << 20, 8 << 20, 2 << 20, 64 << 10},
	{"وحشتناک (insane)", 16, 64, 256, 128 * 1024, 4 << 20, 4 << 20, 16 << 20, 4 << 20, 64 << 10},
}
